        ...
        should("return the leaderboard of all events") {
            ...
            expectThat(result).isRight().with({ value }) {
                get { eventsRanking }.map { it.toEventLeaderboardPair() }.containsExactlyInAnyOrder(
                    Pair(
                        events[0].id, listOf(
                            RankTuple(athletes[2].id, Pair(ScoreType.Time, 299u), 1u, false, 100u),
                            RankTuple(athletes[1].id, Pair(ScoreType.Time, 302u), 2u, false, 95u),
                            RankTuple(athletes[0].id, Pair(ScoreType.Time, 305u), 3u, false, 90u),
                            RankTuple(athletes[3].id, Pair(ScoreType.Time, 320u), 4u, false, 85u),
                        )
                    ),
                    Pair(
                        events[1].id, listOf(
                            RankTuple(athletes[0].id, Pair(ScoreType.Weight, 105u), 1u, false, 100u),
                            RankTuple(athletes[3].id, Pair(ScoreType.Weight, 95u), 2u, false, 95u),
                            RankTuple(athletes[1].id, Pair(ScoreType.Weight, 92u), 3u, false, 90u),
                            RankTuple(athletes[2].id, Pair(ScoreType.Weight, 90u), 4u, false, 85u),
                        )
                    ),
                    Pair(
                        events[2].id, listOf(
                            RankTuple(athletes[0].id, Pair(ScoreType.Reps, 55u), 1u, false, 100u),
                            RankTuple(athletes[1].id, Pair(ScoreType.Reps, 54u), 2u, false, 95u),
                            RankTuple(athletes[2].id, Pair(ScoreType.Reps, 45u), 3u, false, 90u),
                            RankTuple(athletes[3].id, Pair(ScoreType.Reps, 40u), 4u, false, 85u),
                        )
                    ),
                )
            }
